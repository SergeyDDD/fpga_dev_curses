...
HD_PWD='/home/serhii/workspace/fpga/fpga_dev_curses/lesson_6_7/Task_3_plined/Task_3_plined.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_plined.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_plined.tcl -notrace
