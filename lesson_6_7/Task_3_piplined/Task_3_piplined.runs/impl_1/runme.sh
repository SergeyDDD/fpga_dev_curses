...
HD_PWD='/home/serhii/workspace/fpga/fpga_dev_curses/lesson_6_7/Task_3_piplined/Task_3_piplined.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_pipelined.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_pipelined.tcl -notrace
