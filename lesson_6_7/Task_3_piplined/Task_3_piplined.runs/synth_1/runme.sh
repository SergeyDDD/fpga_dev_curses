...
HD_PWD='/home/serhii/workspace/fpga/fpga_dev_curses/lesson_6_7/Task_3_piplined/Task_3_piplined.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_pipelined.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_pipelined.tcl
