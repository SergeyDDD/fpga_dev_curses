...
// Set SIMULATION_CONFIG to '0' for real testing using development kit
// Set SIMULATION_CONFIG to '1' for simulation using Vivado Simulator
#define SIMULATION_CONFIG   1
